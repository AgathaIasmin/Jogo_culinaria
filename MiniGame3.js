const correctOrder = [{
  ...
  {
    name: 'carne',
    img: './assets/img/carne.png'
  },
  {
    name: 'Queijo',
    img: './assets/img/queijo.png'
  },
  {
    name: 'carne',
    img: './assets/img/carne.png'
...
const tutorialSteps3 = [{
    text: "Arraste os ingredientes para o hambúrguer, na ordem do ticket!",
    img: "./assets/img/Madeleine1.png"
  },
  {
    text: "Só pode colocar o ingrediente certo na vez certa!",
    img: "./assets/img/Madeleine2.png"
  },
  {
    text: "Se errar, você perde uma vida. Se acabar o tempo, também!",
    img: "./assets/img/Madeleine3.png"
  },
  {
    text: "Monte o hambúrguer igual ao pedido para vencer!",
    img: "./assets/img/Madeleine1.png"
  }
];
let currentStep3 = 0;
