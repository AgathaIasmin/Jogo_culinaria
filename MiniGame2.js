...
const tutorialSteps2 = [{
    text: "Arraste as carnes para a chapa para começar a fritar!",
    img: "./assets/img/Madeleine1.png"
  },
  {
    text: "Espere o lado dourar, clique para virar e frite o outro lado.",
    img: "./assets/img/Madeleine2.png"
  },
  {
    text: "Quando estiver pronta, arraste para o prato de hambúrgueres prontos.",
    img: "./assets/img/Madeleine3.png"
  },
  {
    text: "Cuidado para não queimar! Se queimar, jogue na lixeira.",
    img: "./assets/img/Madeleine1.png"
  }
];
let currentStep2 = 0;
